 ...
 */
router.get('/opdLogin-dashboard', opdRbacMiddleware, getDashboard);
 ...
 * @access  OPD Staff Only (RBAC)
 */
router.get('/statistics', opdRbacMiddleware, getStatistics);
 ...
 * @access  OPD Staff Only (RBAC)
 */
router.get('/next-patient', opdRbacMiddleware, getNextPatient);
 ...
 * @access  OPD Staff Only (RBAC)
 */
router.get('/patient/:visitId', opdRbacMiddleware, getPatientDetails);
 ...
 */
router.post('/call-patient/:queueId', opdRbacMiddleware, canManageQueue, callNextPatient);
 ...
 */
router.post('/start-serving/:queueId', opdRbacMiddleware, startServing);
 ...
 * @access  OPD Staff
 */
router.post('/complete-service/:queueId', opdRbacMiddleware, completeService);
 ...
 */
router.post('/skip-patient/:queueId', opdRbacMiddleware, canManageQueue, skipPatient);
