...
} from '../controllers/onboarding.validators.js';
import { 
  validateJoinRequest,
...
} from '../services/email.service.js';import { EMPLOYEE_ROLES } from '../rbac/rolePermissions.js';
export class OnboardingService {
  ...
  async registerDoctorWithToken(token, data) {
    ...
    const { validatePasswordRegistration } = await import('../controllers/onboarding.validators.js');
